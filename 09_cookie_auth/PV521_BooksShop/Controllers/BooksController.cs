...
namespace PV521_BooksShop.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        [HttpGet]
        [AllowAnonymous]
        public async Task<IActionResult> GetAsync([FromQuery] PaginationRequestDto dto, [FromQuery] string sortBy = "created", CancellationToken ct = default)
        {
            var response = await _bookService.GetAllAsync(dto, sortBy, ct);
